...
namespace CloudantV1 {
  ...
  export class DatabaseInformation {
    ...
    /** An opaque string to detect whether a database has beenrecreated. The field name is for compatibility with
     *  old replicatorversions. Do not use the value to infer timing infromation. Typicallyonly used by replicators.
     */
